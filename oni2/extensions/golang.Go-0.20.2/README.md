...
> 📣 We plan to enable the language server ([`gopls`](https://github.com/golang/vscode-go/blob/master/docs/gopls.md)) by default in early 2021. The language server
...
Read about [Go code organization](https://golang.org/doc/code.html) to learn how to configure your environment. This extension works in both [GOPATH](https://github.com/golang/vscode-go/blob/master/docs/gopath.md) and [module](https://github.com/golang/vscode-go/blob/master/docs/modules.md) modes.
